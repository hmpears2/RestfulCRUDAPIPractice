...
## API Endpoints
Base URL: [`http://localhost:8080/api/cats`](http://localhost:8080/api/cats)

1. ### [`/`](http://localhost:8080/api/cats) (GET)
...
2. ### [`/{id}`](http://localhost:8080/api/cats/3) (GET)
...
3. ### [`/search`](http://localhost:8080/api/cats/search?name=lynx) (GET)
...
4. ### [`/breed/{breed}`](http://localhost:8080/api/cats/breed/Caracal) (GET)
...
5. ### [`/`](http://localhost:8080/api/cats) (POST)
...
#### Response - The newly created ExoticCat.
{
"exoticCatId": 4,
"name": "Bengal Cat",
"description": "Bengals have stunning leopard-like markings and high energy levels.",
...
6. ### [`/{id}`](http://localhost:8080/api/cats/1) (PUT)
...
#### Response - The updated ExoticCat object.
{
"exoticCatId": 1,
"name": "Serval",
"description": "UPDATED: Known for their spotted coat and incredible jumping abilities up to 10 feet high!",
...
7. ### [`/{id}`](http://localhost:8080/api/cats/3) (DELETE)
